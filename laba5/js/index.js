...
function renderPage() {
  const mainContent = [
    ...
    new StatsBlock(),
    new TextBlock("Дилюк — персонаж игры Genshin Impact, самый богатый холостяк Мондштадта и Пиро-воин с железной волей. Высокий, атлетически сложенный, привлекательный молодой человек со светлой кожей, длинными красными волосами, собранными в хвост, и алыми глазами. Некогда Дилюк был страстным и уверенным в себе юношей, искренне преданным работе с рыцарями Ордо Фавониус. Но после скоропостижной кончины его отца он стал замкнутым и отстранённым, преисполнился горечью. Он не любит тратить время на пустые разговоры и быстро теряет терпение."),
    new TalentBlock(),
